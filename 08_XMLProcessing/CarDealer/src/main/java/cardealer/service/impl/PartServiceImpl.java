...
public class PartServiceImpl implements PartService {
    ...
    @Override
    public void seedPart() throws IOException, JAXBException {
        if(partRepository.count() == 0){
            ...
            final PartImportWrapperDto partsDto = (PartImportWrapperDto) unmarshaller.unmarshal(fileReader);

            final List<Part> parts = partsDto
                    .getParts()
                    .stream()
